...
**POSITION SUMMARY**:
The Child Development Specialist is responsible for providing exceptional, high-quality care and educational experiences for children enrolled in the Exploration Center. This role supports the holistic development of each child by fostering a safe, nurturing, and developmentally appropriate learning environment that promotes growth across all developmental domains. The Child Development Specialist is accountable for ensuring the health, safety, well-being, and engagement of children while implementing best practices in early childhood education. Through intentional interactions, individualized support, and strong partnerships with families, this position contributes to each child's social-emotional, cognitive, physical, and language development and advances the center's mission of excellence in early learning and care.
**ESSENTIAL DUTIES AND RESPONSIBILITIES**:
1. Provide high-quality early childhood education by designing and implementing developmentally appropriate learning experiences that support children's growth across all developmental domains, including social-emotional, physical, language, cognitive, literacy, mathematics, science and technology, social studies, and the arts.
2. Maintain a safe, healthy, and nurturing environment that promotes children's well-being, learning, and development.
3. Ensure full compliance with all applicable licensing, accreditation, and quality standards, including Child Care Regulation (CCR), National Association for the Education of Young Children (NAEYC), Texas Rising Star (TRS), and other regulatory requirements.
4. Model and implement best practices in early childhood education, positive guidance, classroom management, and child development.
5. Observe, assess, and document children's developmental progress and learning outcomes through formal and informal assessments, maintaining accurate records and individualized child portfolios.
6. Foster strong partnerships between home and school by sharing child development information, supporting families with research-based parenting practices, and planning and conducting parent-teacher conferences.
7. Complete and maintain required program documentation, including attendance records, lesson plans, anecdotal observations, accident and incident reports, health and safety monitoring logs, and other required records.
8. Successfully complete all required training and professional development, including Pediatric First Aid/CPR, Child Abuse Prevention and Reporting, Pre-Service Training, and a minimum of 30 hours of annual professional development.
9. Communicate effectively and professionally with children, families, colleagues, and community partners while adhering to the NAEYC Code of Ethical Conduct and the center's professional standards.
**OTHER DUTIES AND RESPONSIBILITIES**
1. Maintain a clean, organized, and sanitary learning environment through routine cleaning, sanitizing, and classroom organization practices.
2. Ensure classrooms are well-equipped with developmentally appropriate materials and resources that encourage exploration, creativity, independence, and child-directed learning.
3. Provide families with guidance and information regarding child development milestones, learning expectations, and age-appropriate developmental practices.
4. Communicate center policies, procedures, and program expectations to staff and families in a clear, respectful, and professional manner.
5. Support the overall operation of the Exploration Center by performing additional duties as assigned and contributing to a positive, collaborative team environment.
**SUPERVISORY RESPONSIBILITY**:
This position may be a mentor or peer-coach to Teacher Aide/Floater and/or Assistant Teacher.
**REQUIRED QUALIFICATIONS**:
1. Associate degree in Early Childhood Education or a related field, or a minimum of 36 college credit hours from an accredited institution in Early Childhood Education, Child Development, Elementary Education, Early Childhood Special Education, or a closely related discipline.
2. Current Pediatric CPR and First Aid certification from an accredited in-person training provider, or the ability to obtain certification within 30 days of hire.
3. Minimum of two years of experience working with infants, toddlers, preschool-aged children, and/or pre-kindergarten children in a licensed childcare center, early learning program, or educational setting serving children from birth through kindergarten.
4. Ability to read, understand, and follow written and verbal instructions in English.
5. Proficiency in computer applications and internet-based platforms, including Microsoft Office Suite (Word, Excel, Outlook), Google Workspace (Gmail, Docs, and related applications), and other technology used to support program operations and documentation.
6. Strong interpersonal and communication skills, with the ability to collaborate effectively with colleagues and build positive, professional relationships with children and families.
7. Demonstrated ability to respond promptly, appropriately, and compassionately to the individual needs of children while maintaining a supportive and nurturing environment.
8. Ability to safely lift, carry, and assist children as needed throughout the workday.
9. Ability to meet the physical demands of the position, including frequent walking, standing, bending, stooping, reaching, and active engagement with children for extended periods.
10. Commitment to fostering an inclusive environment that values diversity, equity, and respect for differing perspectives, backgrounds, and experiences.
11. Strong organizational skills, sound judgment, and the ability to maintain confidentiality while supporting children, families, and program operations.
...
### Daytime Custodian — IRS Site, Blue Solutions

- **Location:**  Austin, TX, US
- **Type:** Full Time
- **Salary:** $17.75 - $22.84
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587164)**

#### Job Description

**Schedule:** Day Shift | 5 days/week, 8.5 hours per day
**About the Role**
Goodwill Central Texas Commercial Services provides janitorial and related contract services while creating meaningful employment opportunities through purpose-driven workforce programs.
As a Daytime Custodian, you will help maintain a clean, safe, and welcoming environment at an IRS facility. This role requires someone who can work independently and take pride in their work. Floor-care machinery is not operated during the day shift.
Reports To: Custodial Team Lead / Supervisor
**Important Program Eligibility Requirement**
This position is part of a federal AbilityOne Program contract. The program provides employment opportunities for individuals who meet specific eligibility requirements, including individuals with a documented medical condition.
During the recruiter screening process, candidates will be asked to disclose details of the medical condition relevant to AbilityOne eligibility and provide medical documentation to verify program eligibility.
If you do not meet the AbilityOne eligibility requirement, please explore other career opportunities with Goodwill Central Texas that are not designated AbilityOne positions.
**Role & Responsibilities**
- Clean and maintain restrooms, fixtures, floors, and other assigned areas using approved products and procedures.- Sweep and mop floors daily.- Complete assigned floor-care tasks that do not require machinery.- Spot-clean doors, walls, windows, and other surfaces.- Restock cleaning and restroom supplies as needed.- Empty trash and transport waste to designated disposal areas.- Safely mix, handle, and use cleaning chemicals according to established safety procedures.- Maintain assigned areas in accordance with contract standards and Blue Solutions expectations.- Adhere to the assigned daytime schedule and maintain reliable and predictable attendance.- Complete required training and follow all applicable safety, security, and facility procedures.- Represent Goodwill Central Texas professionally while working at the customer facility.
**Required Qualifications**
- Ability to lift up to 50 pounds and regularly push, pull, bend, reach, and move throughout the facility during the shift.- Ability to work the assigned daytime schedule with reliable and predictable attendance.- Ability to pass a contract-required background check.- Valid government-issued photo identification and a secondary I-9 document with a matching name.- Selective Service registration or applicable exemption.- AbilityOne Program eligibility based on a documented medical condition. During the recruiter screening process, candidates will be asked to disclose details of their medical condition and provide medical documentation to verify eligibility.
**Preferred Qualifications**
- High school diploma or GED.- At least one year of commercial or federal-contract custodial experience.- Experience working independently while maintaining established cleaning and quality standards.
**Compensation & Benefits**
Goodwill Central Texas offers a competitive hourly wage, along with a Health & Wellness Benefit.
Eligible employees may also have access to:
- 403(b) retirement plan with employer match- Medical, dental, and vision insurance- Company-paid life insurance- Vacation and sick time- Six weeks of paid parental leave- Tuition support- Free mental health counseling- Employee discounts
**Equal Employment Opportunity**
Goodwill Central Texas is an Equal Opportunity Employer. We celebrate diversity and are committed to creating an inclusive workplace where all employees are respected and valued. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability, protected veteran status, gender identity, sexual orientation, or any other status protected by applicable law.
**Background Check**
Employment is contingent upon the successful completion of a pre-employment background check, which may include verification of employment history, education, criminal history, and other information relevant to the position.
#IND2
7:00am-3:30pm

### Custodian - DMV 

- **Location:** DMV Parmer, Austin, TX, US
- **Type:** Part Time
- **Salary:** $0.00 - $17.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586575)**
...
Important Program Eligibility Requirement
This position is connected to the Work Wonders state-use program. The program creates employment opportunities for individuals who meet specific eligibility requirements, including individuals with a documented disability or medical condition.
During the recruiter screening process, candidates will be asked to disclose details of the condition relevant to Work Wonders eligibility and provide supporting documentation to verify program eligibility.
If you do not meet the Work Wonders eligibility requirement, please explore other career opportunities with Goodwill Central Texas that are not designated Work Wonders positions.
**
**
**SCHEDULE:**
PART TIME; MONDAY THROUGH FRIDAY; 5:00 PM - 9:00 PM
**ESSENTIAL DUTIES AND RESPONSIBILITIES:**
...
- **Salary:** $15.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586539)**
...
- **Salary:** $15.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586535)**
...
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Post offer background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
#IND2
Monday-Fridays: 9:00pm-1:30am

### IRS Overnight Custodian

- **Location:**  Austin, TX, US
- **Type:** Full Time
- **Salary:** $17.75 - $22.84
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586504)**

#### Job Description

**About the Role**
Goodwill Central Texas Commercial Services provides janitorial and related contract services while creating meaningful employment opportunities through purpose-driven workforce programs.
As an Overnight Custodian, you will help maintain a clean, safe, and welcoming environment at an IRS facility. This role requires someone who can work independently, take pride in their work, and has strong hands-on experience with floor care and carpet extraction.
**Important Program Eligibility Requirement**
This position is part of a federal AbilityOne Program contract. The program provides employment opportunities for individuals who meet specific eligibility requirements, including individuals with a documented medical condition. 
During the recruiter screening process, candidates will be asked to disclose details of the medical condition relevant to AbilityOne eligibility and provide medical documentation to verify program eligibility. 
If you do not meet the AbilityOne eligibility requirement, please explore other career opportunities with Goodwill Central Texas that are not designated AbilityOne positions. 
**Role & Responsibilities**
- Clean and maintain restrooms, fixtures, floors, and other assigned areas using approved products and procedures.- Sweep and mop floors daily; strip, wax, and buff floors as required.- Perform independent floor care, including operating floor machines and completing required floor-care tasks.- Vacuum carpets daily and perform carpet shampooing/extraction as required by the contract.- Spot-clean doors, walls, windows, and other surfaces.- Restock cleaning and restroom supplies as needed.- Empty trash and transport waste to designated disposal areas.- Safely mix, handle, and use cleaning chemicals according to established safety procedures.- Maintain assigned areas in accordance with contract standards and Goodwill expectations.- Maintain reliable attendance and consistently report for assigned overnight shifts.- Complete required training and follow all applicable safety, security, and facility procedures.- Represent Goodwill Central Texas professionally while working at the customer facility.
**Required Qualifications**
- 1–3 months of custodial experience or completion of an approved custodial training program.- Strong, hands-on experience with floor care and the ability to perform floor-care duties independently.- Ability to operate or learn to operate buffers, floor machines, and carpet extractors.- Ability to lift up to 50 pounds and regularly push, pull, bend, reach, and move throughout the facility during the shift.- Ability to work the assigned overnight schedule with reliable and predictable attendance.- Ability to pass a contract-required background check.- Valid government-issued photo identification.- Selective Service registration or applicable exemption, if required.- AbilityOne Program eligibility based on a documented medical condition. Medical documentation will be required upon hire.
**Preferred Qualifications**
- High school diploma or GED.- At least one year of commercial or federal-contract custodial experience.- Previous experience operating buffers, floor machines, and carpet extractors.- Experience working independently while maintaining established cleaning and quality standards.
**Compensation & Benefits**
Goodwill Central Texas offers a competitive hourly wage based on experience, along with a Health & Wellness Benefit.
Eligible employees may also have access to:
- 403(b) retirement plan with employer match- Medical, dental, and vision insurance- Company-paid life insurance- Paid time off and personal days- Six weeks of paid parental leave- Tuition support- Free mental health counseling- Employee discounts
**Equal Employment Opportunity**
Goodwill Central Texas is an Equal Opportunity Employer. We celebrate diversity and are committed to creating an inclusive workplace where all employees are respected and valued. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability, protected veteran status, gender identity, sexual orientation, or any other status protected by applicable law.
**Background Check**
Employment is contingent upon the successful completion of a pre-employment background check, which may include verification of employment history, education, criminal history, and other information relevant to the position.
...
- **Salary:** $15.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586468)**
...
- **Salary:** $15.00
- **Posted:** Aug 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586314)**
...
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Pre-employment background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
#IND2
Monday-Fridays: Evening Schedule: 8:00pm-4:30am
...
- **Salary:** $16.00
- **Posted:** Aug 25, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586135)**
...
- **Salary:** $15.00
- **Posted:** Aug 17, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585616)**
...
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Post offer background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
#IND2
Monday through Fridays: 5:00pm-1:30am
...
- **Salary:** $17.75 - $22.84
- **Posted:** Aug 13, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584314)**

#### Job Description

**Custodian (IRS Facilities)**
**Position Summary**
For more than 30 years, Goodwill Central Texas' Commercial Services division has proudly served the Central Texas community by delivering reliable, high-quality light assembly, kitting, janitorial, and landscaping services. What sets us apart is not only the quality of our work, but our commitment to creating meaningful employment opportunities for individuals with barriers to employment.
Our mission is rooted in strengthening our community by providing more than just jobs—we help build lifelong careers. Every member of our team contributes to a purpose-driven workforce that brings professionalism, dedication, and pride to every contract we serve.
As an Overnight Custodian, you will provide custodial services at IRS facilities, ensuring clean, safe, and well-maintained environments for our clients. Working alongside Custodial Team Leads and fellow team members, you will play an important role in delivering exceptional service while supporting our mission of workforce development.
Through partnerships with organizations like SourceAmerica and businesses across Central Texas, Goodwill Commercial Services continues to create opportunities that change lives.
**AbilityOne Program Eligibility**
This position is part of a federal service contract operated under the AbilityOne Program and administered by the U.S. AbilityOne Commission.
**In accordance with AbilityOne Program requirements, priority consideration will be given to qualified applicants with documented significant disabilities or accommodations. Individuals with significant disabilities are strongly encouraged to apply.**
Reasonable accommodations will be provided in accordance with the Americans with Disabilities Act (ADA) and other applicable federal laws.
**Compensation**
This position offers a competitive base hourly wage, with pay determined by experience and qualifications. In addition to hourly pay, employees receive a Health & Wellness Benefit designed to help offset the cost of eligible healthcare premiums, providing additional support for your overall well-being.
**Essential Duties & Responsibilities**
- Clean restrooms, including toilets, sinks, urinals, mirrors, floors, and fixtures using approved cleaning products and disinfectants.- Spot clean doors, partitions, walls, windows, and horizontal surfaces.- Restock paper products and other restroom supplies.- Empty trash and transport waste to designated disposal areas.- Vacuum carpeted areas daily and shampoo as required by contract.- Sweep and mop hard surface floors daily; strip, wax, and buff floors as required.- Safely mix and use cleaning chemicals according to established procedures.- Follow all safety rules, policies, and regulations.- Maintain a positive, professional attitude while representing Goodwill Central Texas.- Demonstrate ethical decision-making and comply with the organization's Corporate Compliance Program.- Attend required meetings and complete all mandatory annual training.- Maintain regular attendance and adhere to assigned work schedules.
**Additional Responsibilities**
- Support service recipients, supervisors, and Custodial Team Leads at assigned contract sites.- Perform other job-related duties as assigned.
**Supervisory Responsibilities**
This position has no supervisory responsibilities.
**Required Qualifications**
- One to three months of custodial, cleaning, or related experience, or completion of an approved custodial training program.- Ability to lift up to 50 pounds, with or without reasonable accommodation.- Ability to push, pull, bend, and move throughout buildings during the work shift.- Ability to pass a criminal background check, subject to the requirements of the assigned contract site.- Depending on the service contract, documentation of a qualifying disability may be required.- Must have a Selective Service registration number or qualifying exemption, if applicable.- Must maintain a valid government-issued photo ID.
**Preferred Qualifications**
- High school diploma or GED.- One year of custodial experience in a commercial or federal contract environment.- Experience operating commercial floor care equipment, including buffers and floor machines.
**Benefits**
Eligible employees enjoy a comprehensive benefits package, including:
- Competitive retirement benefits with 403(b) employer match- Affordable medical, dental, and vision insurance- Company-paid life insurance- Generous paid time off- Paid personal days- Six weeks of paid parental leave- Tuition support- Free mental health counseling- Employee discounts and discounted gym memberships
** **
**Equal Employment Opportunity**
Goodwill Central Texas is an Equal Opportunity Employer. We celebrate diversity and are committed to creating an inclusive workplace where all employees are respected and valued. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability, protected veteran status, gender identity, sexual orientation, or any other status protected by applicable law.
**Background Check**
...
- **Salary:** $18.00
- **Posted:** Jul 16, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582417)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586469)**
...
#IND2
5 days per week: 6:00am-2:30pm

### Social Studies Teacher (Night)

- **Location:** Excel Norwood Campus, Austin, TX, US
- **Type:** Part Time
- **Salary:** $22,667.00 - $30,327.00
- **Posted:** Aug 21, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585958)**
...
Eligible employees are required to contribute a portion of their salary to TRS retirement and TRS-Care through automatic payroll deductions. TRS is a defined-benefit retirement system, and employees generally become vested after earning five years of TRS service credit.
Candidates should consider these required retirement contributions when evaluating compensation and long-term employment with the district. Additional information about TRS eligibility, contributions, vesting, and retirement benefits is available through the Teacher Retirement System of Texas.
The Goodwill Excel Center Adult High School is currently recruiting for a Social Studies Teacher for our **Norwood Campus** located at **1015 Norwood Park Blvd, Austin, Tx 78753**.
POSITION SUMMARY:
...
- **Posted:** Aug 19, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585720)**
...
Candidates should consider these required retirement contributions when evaluating compensation and long-term employment with the district. Additional information about TRS eligibility, contributions, vesting, and retirement benefits is available through the Teacher Retirement System of Texas.
**Role**
The **Strategic Projects Coordinator** leads the planning and execution of assigned strategic initiatives and expansion projects from approval through operational handoff. This role translates strategic priorities into clear project plans, coordinates cross-functional owners, manages timelines, budgets, risks, and dependencies, and ensures projects meet established readiness criteria and decision gates. The manager owns the project management process while functional leaders retain responsibility for technical decisions and deliverables within their areas.
The Project Coordinator owns the planning, coordination, reporting, and escalation processes for assigned initiatives, while project sponsors and functional leaders retain decision authority for strategy, resources, compliance, and functional deliverables
**Role & Responsibilities**
**Project Planning and Governance**
- Draft project charters for Senior Director approval that define scope, outcomes, owners, timelines, resource requirements, budgets, and success measures. - Build and maintain integrated project plans across all workstreams.- Develop and maintain project governance structures, reporting cadence, decision points, and escalation protocols approved by the Senior Director or designated project sponsor. - Maintain risk, issue, dependency, and decision logs.- Coordinate the due diligence, documentation, workstream inputs, and timelines required for expansion initiatives to move through established approval gates, including opportunity assessment, greenlighting review, business case development, and implementation following approval of agreements and expansion requests. - Coordinate regulatory milestones for assigned projects, including charter amendments, renewals, authorizer visits, and required submissions. Functional leaders retain responsibility for legal interpretation and content approval.
**Expansion Readiness and Execution**
- Coordinate due diligence across finance, facilities, talent, technology, academics, student supports, governance, compliance, safety, and communications.- Lead integrated planning and readiness for new school openings.- Track progress against expansion and opening criteria and identify gaps requiring leadership decisions.- Plan and facilitate project specific site visits, readiness reviews, and implementation assessments.- Document corrective actions agreed upon by the Senior Director or appropriate functional leader, confirm owners and deadlines, monitor completion, and escalate delays. - Coordinate safety readiness for new campuses and facility projects in partnership with the designated safety leader.- Lead project closeout, operational handoff, and evaluation.
**Cross-functional Coordination**
- Convene assigned project teams, establish deliverables and deadlines in coordination with the Senior Director and functional leaders, and document clear ownership for each workstream. - Monitor commitments and escalate barriers, competing priorities, and resource constraints.- Coordinate working level communication, project deliverables, and timelines with Goodwill shared services, external partners, vendors, authorizers, funders, and community stakeholders, while the Senior Director retains responsibility for executive relationships, negotiations, and organizational commitments. - Develop communication, stakeholder engagement, training, and implementation plans that support successful adoption.- Coordinate required project reporting to partners, funders, authorizers, and regulatory agencies.
**Performance and Decision Support**
- Maintain a portfolio view of assigned expansion and strategic projects and identify capacity needs, competing deadlines, risks, and dependencies to inform leadership decisions about priorities and sequencing. - Develop dashboards and progress reports for the Senior Director, Cabinet, and Board.- Prepare decision materials that identify options, implications, and risks to support recommendations and decisions by the Senior Director and other designated leaders.- Track project budgets, contract milestones, and resource use in partnership with functional owners, and escalate variances or decisions requiring leadership action. - Evaluate project results against approved outcomes and success measures.
**Systems and Scalability**
- Maintain expansion playbooks, project templates, readiness tools, and standard processes.- Document lessons learned and incorporate them into future project planning.- Identify opportunities to improve the efficiency and consistency of expansion efforts.- Develop repeatable systems that support growth across regions and partnerships.- Ensure completed projects are transferred to clear, sustainable operating ownership.
**Other Duties & Responsibilities**
- Support preparation of reports as requested for Board meetings.- Serve as a member of the Implementation Committee to support project planning for proposed systems. - Comply with policies established by federal and state law, including, but not limited to, State Board of Education and local Board policy. - Perform other related duties as assigned. 
**Supervisory Responsibilities**
This position does not have any supervisory responsibilities
**Required Qualifications**
- Bachelor’s degree in business administration, public administration, education, organizational leadership, project management, or related field.- Three years of progressively responsible experience in project management, program management, strategic operations, organizational implementation, or related field.- Demonstrated experience leading complex projects through the full project lifecycle, including scope development, planning, execution, monitoring, handoff, and evaluation.- Experience managing multiple workstreams, timelines, budgets, risks, dependencies, and stakeholder commitments.- Demonstrated ability to coordinate and influence cross functional teams without direct supervisory authority.- Experience developing project plans, readiness tools, dashboards, executive updates, and decision materials.- Ability to analyze information, identify risks and barriers, develop solutions, and escalate issues requiring leadership decisions.- Strong written, verbal, facilitation, and executive communication skills.- Proficiency with Microsoft 365 and project management platforms.- Valid driver’s license and ability to travel periodically to campuses, partner locations, and potential expansion sites.
**Preferred Qualifications**
- Master’s degree in business administration, public administration, education leadership, organizational leadership, project management, or related field.- Project Management Professional certification or comparable project management credential.- Experience leading new school openings, site launches, charter expansion, or organizational growth initiatives.- Experience working in public education, charter schools, nonprofit organizations, government, or another regulated environment.- Experience coordinating projects involving facilities, finance, technology, talent, compliance, communications, and external partners.- Experience managing vendors, contracts, procurement activities, or project budgets.- Experience preparing materials for executive leaders, governing boards, authorizers, funders, or regulatory agencies.- Experience developing repeatable playbooks and systems for multi-site growth.
**Compensation & Schedule**
- Based on experience and qualifications- This position works year-round
What We Offer
Comprehensive Health Coverage: We provide top-tier medical, dental, and vision insurance to ensure you and your family stay healthy and happy.
Generous Paid Time Off: Recharge with our generous PTO policy, which includes vacation days, personal days, and company-wide holidays.
Teacher Retirement System & 403b Participation
...
- **Type:** Full Time
- **Salary:** $54,574.00 - $83,081.00
- **Posted:** Aug 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584335)**
...
Supervisory Responsibility
There are no supervisory responsibilities for this opportunity.
Required Skills & Qualifications 
...
- **Salary:** $54,574.00 - $83,081.00
- **Posted:** Jul 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582358)**
...
Candidates should consider these required retirement contributions when evaluating compensation and long-term employment with the district. Additional information about TRS eligibility, contributions, vesting, and retirement benefits is available through the Teacher Retirement System of Texas.
.
The Goodwill Excel Center Adult High School is currently recruiting for a Social Studies Teacher for our Billy Moore Campus located at 8500 FM 3053, Overton TX 75684.
POSITION SUMMARY:
The Social Studies Teacher is responsible for implementing, developing, and executing instruction of the Goodwill Excel Center vocational curriculum. The Social Studies Teacher will employ a student-centered approach, effectively tailoring the instructional strategies to the individual students’ needs and approaching instruction with creativity and innovation. Strategies may include, but are not limited to direct instruction, one-to-one instruction, seminars, small group learning, self-paced lessons, blended learning and courses, and online learning tools. The Social Studies will work with the instructional team in meeting educational objectives and adhering to the Texas Essential Knowledge & Skills (TEKS) standards.
ESSENTIAL DUTIES AND RESPONSIBILITIES:
- 
...
- **Type:** Part Time
- **Posted:** Jul 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582354)**
...
- **Location:** Excel Exploration Center, Austin, TX, US
- **Type:** Full Time
- **Salary:** $51,701.00 - $65,892.00
- **Posted:** Jul 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582351)**
...
- **Salary:** $51,701.00 - $65,892.00
- **Posted:** Jul 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582352)**
...
- **Salary:** $35.00 - $45.00
- **Posted:** Jul 07, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581775)**

#### Job Description

The CDL Instructor delivers classroom, range, and behind-the-wheel instruction for the Commercial Driver's License (CDL) training and certification program at the Goodwill Career & Technical Academy. Through engaging instruction, coaching, and hands-on training, the instructor prepares students to safely operate commercial vehicles, successfully earn their Commercial Driver's License, and pursue rewarding careers in the transportation industry.
The instructor is also responsible for maintaining a safe and compliant training environment, monitoring student progress, completing required documentation, and supporting program operations to ensure a high-quality learning experience and successful student outcomes.
*NOTE- **This is a contract position with an immediate start. The regular instructional schedule is Monday through Friday from 7:00 a.m. to 3:00 p.m.**
**Role and Responsibilities**
- Deliver classroom, simulation, range, and behind-the-wheel instruction that prepares students to successfully meet all requirements for the Texas Commercial Driver License (CDL) Skills Test.- Develop, maintain, and continuously improve instructional materials, lesson plans, and training resources for both classroom and behind-the-wheel instruction, adapting teaching methods to accommodate diverse learning styles.- Instruct students on applicable policies, procedures, and safety practices while ensuring compliance with all local, state, and federal laws, regulations, and licensing requirements.- Monitor student progress, maintain accurate training records, collect required program data and ensure timely, complete documentation in accordance with organizational and regulatory requirements.- Coordinate student schedules and communicate appointment details, arrival expectations, required documentation, and other program requirements with students and case management staff.- Coordinate the maintenance, repair, and readiness of training vehicles, ensuring rental trucks are operational, repairs are completed promptly, and relevant team members are informed of vehicle status.- Ensure all vehicles, equipment, and training resources are prepared and available for daily instruction and Department of Public Safety (DPS) skills testing.- Maintain the CDL training range by ensuring all supplies and equipment—including cones, signage, awnings, safety materials, and other instructional resources—are organized, functional, and adequately stocked.- Schedule all Department of Public Safety (DPS) skills tests and coordinate driving appointments in accordance with Commercial Learner Permit (CLP) eligibility requirements, including timely scheduling after CLP issuance, communication with students and case managers, and coordination of retesting when necessary.- Monitor student testing outcomes, maintain required records, and submit all program documentation accurately and on time.
**SUPERVISORY RESPONSIBILITY:**
This position does have supervisory responsibilities 
** **
**REQUIRED QUALIFICATIONS:**
- Must be at least 21 years of age.- High school diploma or GED required.- Must hold a valid Commercial Driver License.- Minimum of 5–7 years of verifiable commercial truck driving experience within the past ten (10) years, with a safe driving record as verified by the Texas Department of Public Safety.- Thorough knowledge of federal and state regulations governing commercial motor vehicle operations, including applicable FMCSA and Texas CDL requirements.- Demonstrated knowledge of safe driving practices, defensive driving techniques, and tractor-trailer operation.- Ability to successfully pass a criminal background check and maintain a driving record that meets organizational, insurance, and regulatory requirements. Candidates must have no disqualifying driver-related convictions within the previous five (5) years and no felony or fraud-related convictions that would prevent employment or certification.- Minimum of one (1) year of instructional, training, coaching, or vocational education experience preferred; experience teaching adults in a classroom and/or hands-on training environment is strongly preferred.
**PREFERRED QUALIFICATIONS:**
- One (1) year of vocational education tractor-trailer driver teaching or driver trainer experience.
**Physical Requirements**
- Ability to work in a non-climate-controlled environment.- Ability to sit, stand, walk, bend, stoop, kneel and twist for 8 hours. - Ability to lift 35 pounds frequently. - While performing the duties of this job, the employees is regularly required to talk, hear, and use hands and fingers to operate a computer and telephone. - Specific vision abilities required by this job include close vision requirements due to computer work. - Regular, predictable attendance is required as business demands dictate.
** **
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all Team Members. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
...
- **Salary:** $35.00 - $50.00
- **Posted:** Jul 07, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581776)**

#### Job Description

The Plumbing Instructor is a contract instructional opportunity for a licensed plumbing professional who is passionate about sharing their knowledge and preparing adult learners for successful careers in the plumbing industry. You'll combine classroom instruction with hands-on training, helping students develop the technical skills, professionalism, and confidence needed to enter the workforce.
**The Goodwill Career & Technical Academy is seeking an experienced Plumbing Instructor to lead our next cohort of aspiring skilled trades professionals beginning in September 2026.**
**Role and Responsibilities**
- Deliver engaging classroom and hands-on instruction using the NCCER Plumbing curriculum.- Teach plumbing fundamentals, blueprint reading, pipefitting, plumbing codes, system installation, maintenance, and repair techniques.- Demonstrate safe work practices and proper use of tools, equipment, and personal protective equipment (PPE).- Supervise students during lab activities while reinforcing industry standards and jobsite safety.- Bring lessons to life through real-world examples, demonstrations, and practical applications drawn from your professional experience.- Create an inclusive learning environment that supports students with varying learning styles and experience levels.- Monitor student progress, provide coaching and feedback, and maintain accurate attendance, testing, and program documentation.- Assist with curriculum updates and instructional materials to ensure training remains current with industry standards.- Ensure all instruction complies with applicable local, state, and federal regulations.
**Supervisory Responsibility**
This position does not have supervisory responsibilities 
**Required Qualifications**
- Must be 21 years of age. - Possess high school diploma or GED.- Extensive experience as a licensed plumber in the residential and/or commercial plumbing industry with in-depth knowledge of plumbing systems, codes and regulations.- Must be able to pass a background check.- A passion for inspiring students to pursue a career as a plumber.
**PREFERRED QUALIFICATIONS:**
- Master Plumber License.- Experience teaching the NCCER Plumbing curriculum.- OSHA 10 Outreach Authorized Trainer credential.- Experience developing partnerships with plumbing contractors, employers, or industry organizations.- Experience preparing students for industry-recognized certifications.- At least (1) year of previous experience teaching in a classroom environment.
**Physical Requirements**
- Ability to work in a non-climate-controlled environment.- Ability to sit, stand, walk, bend, stoop, kneel and twist for 8 hours. - Ability to lift 35 pounds frequently. - While performing the duties of this job, the employees is regularly required to talk, hear, and use hands and fingers to operate a computer and telephone. - Specific vision abilities required by this job include close vision requirements due to computer work. - Regular, predictable attendance is required as business demands dictate.
** **
**Equal Employment Opportunity Statement:**
...
- **Salary:** $22,667.00 - $30,327.00
- **Posted:** Jul 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581653)**

#### Job Description

The Goodwill Excel Center Adult High School is currently seeking an English as a Second Language (ESL) Teacher for our Norwood Campus, located at 1015 Norwood Park Blvd, Austin, Texas 78753. 
Company:
For more than six decades, **Goodwill Central Texas** has been relentlessly focused on empowering thousands of people to work. We transform revenue from over 37 retail locations into a combination of education, career training, job placement, career coaching and support, and more. Every time you shop or support Goodwill, you are helping fund our greater mission to serve our community. Goodwill’s vision extends far beyond our retail stores and your generous donations: We envision a Central Texas where everyone has the opportunity to thrive.
The **Goodwill Excel Center for Adults** opened in 2014 as an open-enrollment public charter high school for adults ages 18 to 50. The Excel Center Adult High School transforms lives in a supportive and holistic learning environment where all students are empowered to achieve. 
For more information on the Goodwill Excel Center Adult High School, visit https://excelcenterhighschool.org
...
**Required Qualifications**
- Bachelor’s degree from an accredited college or university.- Current Texas Teaching Certification in English Language Arts (HS grades) and English as a Second Language (ESL). - Must have a proven record of results that illustrate the teacher’s ability to increase student achievement utilizing subject-specific instructional strategies.- Must have a broad knowledge of the principles and practices of current educational trends in curriculum and instruction.- Must have working knowledge of computer programs and accessing internet applications such as Student Information Systems, Microsoft Products, Google Applications (Gmail), and Internet Explorer.- Excellent oral & written communication skills; ability to convey ideas & instructions clearly & concisely. - Skill to interpret and apply rules, regulations, policies, and procedures. - Skill in organizing and maintaining accurate records. - Must possess the essential mindset that all students can achieve at high levels.- Strong interpersonal and communication skills, with the ability to engage and motivate diverse populations.- Demonstrated commitment to supporting adult learners in achieving their educational and career goals.- Possess understanding of marginalization and how it impacts those Goodwill serves and employs; Exhibit respect for diversity of thought and have experience to advance it in teams/organization.- Exhibit respect for diversity of thought and have experience to advance it in teams/organization** **
** **
**Preferred Qualifications**
- Bilingual
**What We Offer**
...
- **Type:** Full Time
- **Salary:** $63,443.00 - $91,710.00
- **Posted:** Jul 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581652)**

#### Job Description

Pipeline Notification
The Goodwill Excel Center is actively building a high-performing talent pipeline for future Academic Success Coordinator opportunities. This evergreen posting is designed to identify and engage visionary school leaders who are passionate about transforming adult education (ages 18–50) across Texas.
...
- Serve as the campus testing coordinator for all assessments, overseeing logistics, compliance, staff training, and test security, ensuring assessment integrity.- Document all advising interventions, scheduling actions, and progress monitoring in an electronic database accurately, promptly, and in alignment with organizational standards.
**Other Duties and Responsibilities**
- Act as the designated administrator in charge in the absence of the Campus Director, maintaining campus operations and supporting staff and student needs.- Comply with policies established by federal and state law, including, but not limited to, State Board of Education and local Board policy. - Assist with outreach & engagement events (periodically at nights and on weekends).  - Perform other related duties as assigned.  
**Supervisory Responsibilities**
...
- **Type:** Full Time
- **Posted:** Jun 24, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581190)**
...
- **Posted:** Apr 30, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=578150)**
...
This position does not have supervisory responsibilities; however, the position serves as the designated Administrator in Charge in the absence of the Campus Director. 
**Required Skills and Qualifications**
- Bachelor’s degree from an accredited college or university.- Masters’s degree OR Active Texas Teaching Certification (Grades 6-12)- Knowledgeable with Texas graduation planning for high school learners.- Understand the socioemotional, behavioral, and educational trends related to an adult-academic setting.- Must have a working knowledge of computer programs and accessing internet applications such as Student Information Systems, Microsoft Office Products, and Google Applications (Gmail). - Must possess superior verbal and written communication skills.- Must possess high organizational skills and be detail oriented. - Must be self-motivated willing to be a team player.- Ability to gather and analyze data for informed decision-making.  - Experience working with high school age students in urban, non-traditional, and/or adult education setting; Possess understanding of marginalization and how it impacts those Goodwill serves and employs; Exhibit respect for diversity of thought and have experience to advance it in teams/organization.
** **
**Preferred Qualifications**
- Master’s degree from an accredited college or university- Texas School Counselor or Principal Certification- Bilingual in Spanish and English.
Compensation & Schedule
...
- **Type:** Full Time
- **Posted:** Apr 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=576587)**

#### Job Description

**Pipeline Notification**
**The Goodwill Excel Center is currently seeking passionate educators to join our teacher pipeline.** This is an **evergreen posting** designed to identify and engage talented instructors for future openings across our campuses. By applying, you are expressing interest in being considered for upcoming opportunities as they arise.
We are specifically looking for teachers with certifications (Grade 6-12) and an interest in teaching the following subjects:
- **English**- **Math**- **Science**- **Social Studies**- **ESL (English as a Second Language)**
Company:
For more than six decades, **Goodwill Central Texas** has been relentlessly focused on empowering thousands of people to work. We transform revenue from over 37 retail locations into a combination of education, career training, job placement, career coaching and support, and more. Every time you shop or support Goodwill, you are helping fund our greater mission to serve our community. Goodwill’s vision extends far beyond our retail stores and your generous donations: We envision a Central Texas where everyone has the opportunity to thrive.
The **Goodwill Excel Center for Adults** opened in 2014 as an open-enrollment public charter high school for adults ages 18 to 50. The Excel Center Adult High School transforms lives in a supportive and holistic learning environment where all students are empowered to achieve. 
For more information on the Goodwill Excel Center Adult High School, visit https://excelcenterhighschool.org
...
Candidates should consider these required retirement contributions when evaluating compensation and long-term employment with the district. Additional information about TRS eligibility, contributions, vesting, and retirement benefits is available through the Teacher Retirement System of Texas.
**Position Summary**
The primary role of the High School Teacher for Adult Education is to implement, develop, and execute instruction of the Goodwill Excel Center curriculum. You will employ a student-centered approach, tailoring instructional strategies to meet the unique needs of adult learners through creativity and innovation. Strategies include direct instruction, seminars, small group learning, and blended or online learning tools. You will collaborate with the instructional team to meet educational objectives while adhering to Texas Essential Knowledge and Skills (TEKS) standards.
**Essential Duties and Responsibilities**
- Provide high-quality instruction in core content areas (English, Math, Science, Social Studies, or ESL) to ensure student mastery of TEKS.- Develop and revise curriculum, including lesson plans, projects, and assessments aligned with Excel Center and TEKS standards.- Assess individual progress to shape and differentiate instruction based on student needs.- Utilize attendance, grades, and assessment data to refine lessons and achieve learning goals.- Implement a consistent classroom management system that fosters character development and a sense of community.- Provide tutorials and support to ensure all students achieve academic success.- Maintain accurate attendance and progress records according to District policy.- Participate in school-wide functions and professional development aimed at improving student retention and school culture.
**Required Qualifications**
- **Education:** Bachelor’s Degree in Education or a related field.- **Certification:** Current Texas Teaching Certification in relevant High School content areas (Secondary grades).- **Experience:** Proven record of increasing student achievement; experience with Special Education/504 services, English Language Learners, and immigrant populations.- **Skills:** Proficiency in Microsoft Products, Google Applications, and Student Information Systems.- **Communication:** Superior verbal and written communication skills in English.- **Mindset:** A strong belief that all students can achieve at high levels and an understanding of how marginalization impacts the community we serve.- **Compliance:** Ability to successfully pass a background check and complete fingerprinting requirements.
**Preferred Qualifications**
- **ESL Certification:** Texas English as Second Language (ESL) Certification.- **Advanced Degree:** Master’s in Education or a related field.- **Adult Education:** 1+ years of experience providing instruction to adults or working in non-traditional/urban education settings.- **Bilingual:** Proficiency in Spanish or Arabic.
**Physical Requirements **
...
- **Salary:** $0.00 - $21.28
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586798)**
...
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586945)**
...
- **Salary:** $21.00
- **Posted:** Aug 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586318)**

#### Job Description

The Floor Care Supervisor leads floor care operations, supervises technicians, ensures quality standards, safety compliance, equipment readiness, employee development, and customer satisfaction.
**Role and Responsibilities**
- Supervise and lead Floor Care Technicians and assigned custodial staff.- Plan, schedule, and coordinate daily and periodic floor care projects.- Train, coach, and develop team members on proper floor care procedures, equipment operation, and safety practices.- Oversee specialized floor maintenance services, including:- Floor stripping and refinishing- Waxing and sealing- Burnishing and buffing- Carpet extraction and cleaning- Tile and grout cleaning- Other hard floor maintenance services- Conduct routine quality inspections to ensure work meets company and client standards.- Ensure compliance with all company policies, OSHA regulations, SDS requirements, and workplace safety procedures.- Monitor the condition, maintenance, and accountability of floor care equipment and vehicles.- Maintain inventory of supplies and recommend replenishment as needed.- Complete required reports, work orders, inspections, and documentation accurately and on time.- Communicate professionally with customers to address service requests, concerns, and project updates.- Assist management with staffing, scheduling, and operational planning to meet service commitments.
** **
**Supervisory Responsibility**
This position directly supervises Floor Care Technicians and assigned custodial staff. The Floor Care Supervisor will provide training, coaching, performance feedback & daily work direction. The Supervisor is responsible for promoting teamwork, accountability and adherence to company standards.
** **
**Required Skills & Qualifications **
- Minimum of two (2) years of commercial floor care experience.- Previous leadership or supervisory experience preferred.- Working knowledge of commercial floor care equipment and maintenance techniques.- Understanding of Safety Data Sheets (SDS), OSHA guidelines, and workplace safety standards.- Valid driver's license with an acceptable driving record.- Bilingual (English/Spanish) preferred.- Strong organizational, communication, and customer service skills.- Ability to prioritize multiple assignments and work independently.
**Physical Requirements**
- Ability to lift and carry up to 50 pounds.- Ability to stand, walk, bend, kneel, crouch, and reach for extended periods.- Ability to operate commercial floor care equipment safely and effectively.- Ability to work in a variety of indoor and outdoor environments, including exposure to cleaning chemicals, noise, and changing temperatures.- Ability to perform repetitive physical tasks associated with commercial floor maintenance.
** **
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all Team Members. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
...
- **Salary:** $58,000.00 - $63,999.00
- **Posted:** Aug 25, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586154)**
...
- **Posted:** Aug 22, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586015)**

#### Job Description

The Purchasing Assistant Manager supports the Purchasing Manager in executing product acquisition, procurement, inventory control, and merchandising strategies.  This position also leads daily operations of the New Goods Warehouse, ensuring safe and efficient workflows, maintaining inventory accuracy, and supervising warehouse staff.
**Role and Responsibilities**
- Develop and maintain strong and effective vendor relationships to identify and procure merchandise appropriate for Goodwill retail stores.- Attend tradeshows and industry events when necessary to source new vendors and stay current with market trends.- Supervise daily operations of the New Goods Warehouse including receiving, inventory control, and order fulfillment. - Ensure accurate documentation and procedures are followed from product receipt through distribution.- Oversee product labeling, UPC accuracy, and system entry prior to store shipment.- Collaborate with the Purchasing Manager to align warehouse inventory with retail order demands.- Assist with development and implementation of merchandising strategies, SOPs, and retail store rollouts.- Coordinate shipment schedules with the logistics team to fulfill retail store needs.- Track and confirm store order fulfillments in assigned systems; ensure all inventory data is accurate and timely.- Lead and train New Goods staff, maintaining productivity within budget and Goodwill policy.- Uphold safety, cleanliness, and professionalism throughout the warehouse.- Foster strong communication with internal departments to improve process flow from procurement through sales.- Ensure accurate documentation and clear communication across Retail and Finance departments.- Evaluate feedback and recommend process improvements.- Ensure compliance with inventory, accounting, and operational policies.- Attend scheduled meetings and training.- Other duties as assigned. 
**Supervisory Responsibility**
This position has supervisory responsibilities over the New Goods Merchandise Processors.
**Required Skills & Qualifications **
- Bachelor’s or associate degree in business, finance, or account preferred. - Minimum 2 years of experience in procurement or buying preferred.- Minimum 2 years of supervisory experience in retail, merchandising, logistics, inventory, or fulfillment operations.- Strong attention to detail and analytical skills.- Effective communicator in verbal and written English.- Proficient with Microsoft Office; experience with inventory software preferred.- Valid Texas Driver’s License.- Demonstrated problem-solving, adaptability, and team leadership.- Demonstrated ability to multi-task and prioritize.- Commitment to fostering diverse and inclusive teams.- Ability to work with all levels of staff. 
**Physical Requirements **
...
- **Posted:** Aug 20, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585873)**
...
** **
**Physical Requirements**
**Standing/Walking**: Ability to stand and walk for extended periods (up to 8 hours or more) throughout the workday, including on hard surfaces.
**Lifting/Carrying**: Frequently lift and carry merchandise, donations, or supplies weighing up to **50 pounds** unassisted; occasionally assist with heavier items using team lift techniques or equipment.
**Pushing/Pulling**: Push or pull carts, racks, or bins of merchandise and donations, which may exceed 100 pounds with appropriate equipment.
**Bending/Kneeling**: Regularly bend, stoop, kneel, and crouch to retrieve, organize, or stock items.
**Reaching/Handling**: Reach overhead and at ground level; use hands and fingers to handle merchandise, tags, hangers, and point-of-sale systems.
**Visual/Auditory Acuity**: Must have the visual and auditory ability to identify hazards, operate machinery (e.g., balers, pallet jacks), and interact effectively with customers and team members.
**Climbing**: Occasionally use step stools or ladders to retrieve or stock merchandise.
**Environmental Conditions**: Work in varied indoor and outdoor environments, including donation receiving areas, which may be subject to fluctuating temperatures, weather, dust, and noise.
...
- **Posted:** Aug 18, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585722)**
...
- **Salary:** $46,000.00 - $49,999.00
- **Posted:** Aug 18, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585715)**
...
- **Salary:** $50,000.00 - $55,999.00
- **Posted:** Aug 18, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585714)**
...
- **Posted:** Aug 17, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585609)**
...
- **Salary:** $21.00
- **Posted:** Aug 13, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584322)**
...
- Nurtures our Culture and Mission- Gets Results Through Self and Others- Inspires and Develops Talent- Collaborates and Connects Across Boundaries
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Post offer background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
#IND2
7:00am-3:30am
...
- **Salary:** $46,000.00 - $49,999.00
- **Posted:** Aug 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583930)**
...
- **Salary:** $74,508.00 - $88,908.00
- **Posted:** Aug 06, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583731)**
...
Eligible employees are required to contribute a portion of their salary to TRS retirement and TRS-Care through automatic payroll deductions. TRS is a defined-benefit retirement system, and employees generally become vested after earning **five years of TRS service credit**.
Candidates should consider these required retirement contributions when evaluating compensation and long-term employment with the district. Additional information about TRS eligibility, contributions, vesting, and retirement benefits is available through the Teacher Retirement System of Texas.
The Director of Student Wellness (DSW) at the Excel Center High School is a district level leader responsible for providing strategic leadership and oversight of student mental health and wellness supports, behavioral intervention, restorative practices, and school-based wellness structures across community-based school sites. This role provides leadership, coordination, and support to the Mental Health and Wellness (MHW) team while promoting consistent, trauma-informed, equitable, and student-centered practices across schools.
The Director of Student Wellness leads the development, implementation, and refinement of systems related to behavioral support, restorative intervention, Behavioral Threat Assessment (BTA), crisis response, disciplinary and restorative processes, and student mental health services. While mental health services and behavioral/disciplinary interventions remain campus functions, this role ensures system-wide integration and alignment across related supports. The Director balances systems leadership with hands-on implementation support through staff coaching, case consultation, documentation support, process development and facilitation, and cross-functional collaboration.
This role works closely with district leadership, Campus Directors, Mental Health and Wellness (MHW) clinicians, and external partners to strengthen organizational capacity and ensure student wellness systems are consistent, compliant, and effective. The Director fosters environments that promote student persistence, safety, belonging, and success while remaining responsive to the unique needs of adult learners. 
**Role & Responsibilities**
**Mental Health and Wellness Leadership**
- Provide direct leadership, supervision, coaching, support, evaluation, and performance management to the Mental Health and Wellness Team.- Lead, coach, and support MHW staff in delivering trauma-informed, culturally responsive, clinically grounded, evidence-based, and strengths-based services to students.- Ensure consistency and quality of mental health and wellness support across community school sites, including review and refinement of MHW programming.- Facilitate team meetings, case consultations, reflective supervision structures, and professional development opportunities.- Lead, coordinate, and support crisis response planning for student mental health concerns.- Provide oversight and monitoring of referral processes, service delivery workflows, documentation practices, and follow-up systems related to student mental health and wellness.- Collaborate with district and campus leadership to identify and address barriers impacting student well-being, engagement, and persistence.- Manage relationships and coordination with external licensure supervisors for mental health staff to support ethical and professional practice.- Build and maintain relationships with community mental health providers, crisis services, and external support agencies to strengthen referral networks.- Develop, lead, and coordinate training for team members on mental health and risk-related topics including suicide prevention, abuse and trafficking reporting, trauma-informed practices, and threat assessment.
**Behavioral Intervention and Restorative Practices Support**
- Lead the development of a community school framework for behavioral intervention and restorative practices, as well as related systems and processes.- Provide leadership and consultation to Campus Directors in implementing behavioral intervention systems aligned with restorative, trauma-informed, and relationship-centered practices.- Develop and facilitate training and support for campus leadership in de-escalation, restorative conversations, mediation, re-engagement planning, and proactive behavioral supports.- Provide consultation to campus leaders regarding behavioral strategies and complex student situations.- Develop and maintain intervention protocols, documentation tools, communication workflows, and behavioral response procedures.- Analyze behavioral trends and identify opportunities for prevention and system improvement.- Build staff capacity related to restorative practices, trauma-informed response, and student behavior support.
**Behavioral Threat Assessment (BTA) & Safety Coordination**
- Lead and oversee the Behavioral Threat Assessment (BTA) process across community-based schools in alignment with Texas Education Agency guidelines and organizational procedures.- Ensure consistent implementation of BTA protocols, documentation requirements, communication procedures, and follow-up actions.- Facilitate and support multidisciplinary threat assessment meetings as needed.- Maintain compliance with organizational and legal requirements related to student safety and risk assessment.- Develop training materials and decision-making tools related to student safety and threat assessment for Campus Director use.
**Discipline and Expulsion Processes**
- Provide leadership and consultation to Campus Directors in implementing disciplinary and expulsion processes in alignment with TEA standards, organizational policy, student rights, and restorative practices.- Ensure disciplinary procedures are implemented consistently, equitably, and with appropriate documentation and reporting.- Provide consultation and facilitation support in complex disciplinary situations, including leading expulsion hearings when applicable.- Oversee communication, documentation, and procedural follow-through related to suspension, expulsion, and re-entry processes.
**Systems Development**
- Provide strategic leadership for ongoing evaluation, refinement, and scalability of districtwide student wellness systems to ensure consistency, effectiveness, and alignment with organizational priorities.- Lead the development, documentation, and implementation of scalable systems, tools, workflows, templates, and protocols related to student mental health, behavioral intervention, restorative practices, BTA, and discipline.- Ensure systems are clearly documented, organized, and consistently implemented across campuses.- Analyze stakeholder feedback and program data to support continuous improvement of systems and practices.- Partner with Senior Director of Student Supports to identify implementation gaps, priorities, and operational needs as well as scalability factors for future expansion.- Develop written guidance, training materials, process maps, and implementation tools to support consistency across campuses.- Lead onboarding and training for new staff related to student wellness and behavioral systems.- Partner with internal stakeholders to ensure system-wide integration of student support systems (e.g. MTSS, Special Programs, Coaching referral systems, etc.)- Monitor and evaluate program effectiveness and compliance and complete reports as indicated.
**Other Duties & Responsibilities**
- Attend team and professional meetings as required.- Support organizational initiatives related to student well-being, safety, retention, and school culture.- Maintain consistent onsite presence aligned with assigned district schedule and campus operational needs.- May oversee District Homeless Liaison.
**Supervisory Responsibilities**
This position provides administrative supervision, coordination, and operational oversight to Mental Health and Wellness Licensed Clinicians. Clinicians who are not fully licensed receive additional supervision from a board-approved external licensed supervisor.
**Required Qualifications**
- Master’s degree in Social Work, Counseling, Educational Leadership, Education, Human Services, Behavioral Sciences or a closely related field.- Independent clinical licensure (LCSW, LPC, or LMFT) is strongly preferred. Candidates with significant leadership experience in student wellness, behavioral health, and supervision of multidisciplinary teams may also be considered.- Minimum of five years of progressively responsible experience in student supports, behavioral intervention, mental health, restorative practices, school leadership, or a related field.- Experience supervising multidisciplinary mental health, student support, behavioral, or related professional staff.- Experience managing complex student situations involving behavior, crisis response, mental health concerns, and student support planning.- Experience working in an academic setting.- Strong knowledge of trauma-informed practices, restorative approaches, de-escalation strategies, socio-emotional development, and adult learner support systems.- Strong organizational, strategic planning, systems-development, implementation, documentation, and data-informed decision-making skills.- Excellent verbal and written communication, collaboration, relationship-building, and community partnership skills, with the ability to engage effectively with diverse populations.- Demonstrated ability to analyze situations, exercise sound judgment, and maintain confidentiality.- Demonstrated ability to lead change, build organizational systems, and implement initiatives across multiple stakeholders.- Proficiency with Student Information Systems, Microsoft Office Suite, Google Workspace applications, and other web-based data management and communication platforms.- Demonstrated ability to work independently and collaboratively, manage competing priorities, adapt to change, and maintain a positive and solution-focused approach.- Belief that all students can achieve at high levels.- Commitment to equity and understanding of the impact of marginalization on the populations Goodwill serves.- Valid Driver’s License, up-to-date auto insurance and good driving record.- Must be able to understand work instructions in English.- Must be able to successfully pass a background check and complete fingerprinting. 
**Preferred Qualifications**
- Experience designing and implementing organizational systems and cross-functional initiatives.- Experience in community-based, alternative, charter, adult education, or non-traditional school settings.- Experience with Behavioral Threat Assessment processes.- Knowledge of community resources, behavioral health systems, and referral networks.- Bilingual in Spanish or Arabic and English. 
**Work Schedule & Campus Expectations**
The Director of Student Wellness is part of the District Office Team and expected to work onsite Monday through Friday in accordance with assigned operating hours. Occasional evening hours may be required based on campus, student, or staff needs.
...
- **Location:** Excel Coleman Campus, Lockhart, TX, US
- **Type:** Full Time
- **Salary:** $81,113.00 - $112,780.00
- **Posted:** Jul 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581561)**

#### Job Description

**Pipeline Notification**
**The Goodwill Excel Center is actively building a high-performing talent pipeline for future Campus Director opportunities. This evergreen posting is designed to identify and engage visionary school leaders who are passionate about transforming adult education (ages 18–50) across Texas.**
**By engaging with this pipeline, candidates express early interest in directing our holistic learning environments, leading certified instructional teams, and owning whole-campus outcomes.**
Company:
For more than six decades, **Goodwill Central Texas** has been relentlessly focused on empowering thousands of people to work. We transform revenue from over 37 retail locations into a combination of education, career training, job placement, career coaching and support, and more. Every time you shop or support Goodwill, you are helping fund our greater mission to serve our community. Goodwill’s vision extends far beyond our retail stores and your generous donations: We envision a Central Texas where everyone has the opportunity to thrive.
The **Goodwill Excel Center for Adults** opened in 2014 as an open-enrollment public charter high school for adults ages 18 to 50. The Excel Center Adult High School transforms lives in a supportive and holistic learning environment where all students are empowered to achieve. 
...
- **Salary:** $58,000.00 - $74,999.00
- **Posted:** Jun 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581370)**

#### Job Description

Goodwill Central Texas’ General Manager in Training (GMIT) South- position is designed to prepare individuals for leadership roles within their retail operations. This training program emphasizes hands-on experience, team development, and alignment with Goodwill's mission to transform lives through the power of education and work.
**Key Responsibilities**
**Retail Operations & Store Management**
- Responsible for the overall operation of the retail store, including opening, closing, and daily execution of all store functions.- Oversee all production levels and ensure the quality of merchandise processed to the sales floor meets revenue and quality standards.- Manage inventory levels across all merchandise lines, ensuring proper flow of goods to and from the store.- Monitor and ensure effective donation processing that complies with security, safety, and state regulatory standards.- Maintain a clean, organized, and well-stocked store environment aligned with brand standards and budgetary goals.
**Staffing, Training, & Development**
...
- **Salary:** $50,000.00 - $55,999.00
- **Posted:** Jun 22, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=581033)**
...
- **Location:**  Austin, TX, US
- **Type:** Full Time
- **Salary:** $0.00 - $65,000.00
- **Posted:** Jun 12, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=580179)**

#### Job Description

The Business Development Manager (BDM) networks, develop relationships with new prospects and provides outstanding customer service.  This position secures new business opportunities for the company, while maintaining existing customer contracts.  The BDM represents the organization in the business community. 
**Role and Responsibilities**
- Develop staffing sales accounts through a combination of methods that may include all or in part, customer research, lead generation, prospecting, networking and in-person appointments with new, inactive and current clients. - Generate staffing sales account leads through prospecting wand cold calling, both in-person and via telephone. Use of other electronic media such as social networking tools and techniques for generating leads and connections. - Create and maintain a staffing sales business plan utilizing a CRM system. Keep customer information fresh and relevant with timely entry of data. - Generate viable client job orders from new, inactive and current accounts. Track and move opportunities through the staffing sales funnel. - Meet minimum requirements for quarterly appointment activity and staffing sales revenue growth. Listen to the customers’ needs and learn about their business so you can provide a clear and concise plan of value to assist them with their staffing needs. - Actively contributes to the growth and community image of the organization as directed by management and the leadership team. - Stay updated on industry trends and the competitive landscape.- Collaborate with internal business partners to ensure understanding of our business needs to effectively know what markets and customers to target. - Other duties as assigned. 
**Supervisory Responsibility**
This position does not have supervisory responsibilities  
**Required Skills & Qualifications **
- Must have a valid driver’s license with reliable transportation and valid proof of insurance. - BA or BS degree in related field. A minimum of five years of experience working with businesses in the area of development, sales and/or programs can replace a four-year degree. - Strong analytical and contract negotiation skills, 3 years of staffing sales experience or relevant sales experience. - Experience using a CRM system. - Proficient with the Microsoft Office Suite. - Strong written and oral communications skills. - Demonstrated ability to build your own pipeline and drive sales from prospecting to final close. 
**Physical Requirements **
...
### Disability Career Case Manager

- **Location:**  Austin, TX, US
- **Type:** Full Time
- **Salary:** $0.00 - $21.28
- **Posted:** Jun 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=579877)**

#### Job Description

The Disability Career Case Manager supports the basic needs and service coordination for Goodwill clients with disabilities seeking assistance with education, job training, internships and employment-related services. The Disability Career Case Manager will work closely with clients in developing internship/work experiences, service plans including goals for training, education, and employment as well as providing continued programmatic follow-up supports postplacement. The Disability Career Case Manager works closely with other Workforce Advancement professionals, the Texas Workforce Commission – Vocational Rehabilitation, and additional community partners in coordinating services provided within and outside of Goodwill.
**Role and Responsibilities**
- Maintain client caseloads by supporting client’s development with respect to resume building, job applicants/job searching, interviewing and employment related soft skills. Maintain frequent contact with clients in accordance with agency policy and procedures. - Develop partnership with clients, a strengths-based/solution-focused assessment and individualized career plan that identifies short- and long-term goals and resources that support clients on their path towards their education, training and employment goals. Track and document goal acquisitions and support clients in their transition to the next steps according to their individual career plan. - Lead internship programs, contingent on program launch and funding. Focused on establishing employer relationships and leveraging pipelines to foster short term and long term work experiences for individuals with disabilities.- Ensure compliance with Texas Workforce Commission – Vocational Rehabilitation program requirements.- Apply extensive knowledge of regional labor market needs and trends which will support an evidence-based career path for clients. - Provide onsite job coaching, including skill development, workplace behavior, and accommodations to clients, specifically working with individuals with disabilities.- Coordinate with appropriate social services professionals in delivering services necessary to support clients in achieving employment stability. - Intervene effectively and ethically in crisis, developing applicable interventions and follow-up plans to thoroughly address immediate and future needs while maintaining safety. - Enroll clients in programs, obtain information and complete reports to meet/exceed all performance targets as required by Goodwill and other funding sources. - Maintain complete and accurate records of all clients through CaseWorthy and other required client tracking databases. Strictly adhering to all data entry requirements set forth by Goodwill and other funding sources. Adhere to confidentiality protocols related to electronic and paper files and documents. - Coordinate and work collaboratively with GCT Career Advancement Team to connect clients with career advancement training and the Business Solutions team to connect clients with employment opportunities. - quality and integrity of Career Advancement Services in CaseWorthy. Pull reports as needed for department. - Participate in and contribute to community collaborations and inter-agency discussions that further the Goodwill mission and clients’ goals. - Other duties as assigned.
**Supervisory Responsibility**
This position does not have supervisory responsibilities
**Required Skills & Qualifications **
- Bachelor’s degree (or higher) in education, business, or a social services related field. Associate degree with a minimum of 1 year experience working with clients in employment counseling, placement, education, or human services can substitute for the four-year degree. Minimum of 1 year experience with socially disadvantaged individuals 9e.eg. Homeless, ex-offenders, and low literacy, etc.) and individuals with disabilities.- Must possess understanding of marginalization and how it impacts those Goodwill serves and employes.- Knowledge of Goodwill services and of community resources and business networking preferred.- Extensive experience with Microsoft Office (Word, Excel, PowerPoint, outlook), and other Social Medica applications.- Valid drivers license, proof of valid insurance and ability to travel on work related business to meet client location/service delivery needs.- Knowledge of client assessment skills, community resources coordination, career planning principles, employability skills, and crisis intervention.- Ability to conduct and/or translate training sessions bilingually preferred.
** **
**Preferred Requirements**
- Certification in Job Coaching or Vocational Rehabilitation (e.g., CRC – Certified Rehabilitation Counselor, CPRW – Certified Professional Résumé Writer) is a plus.- Experience working with diverse populations, including individuals with intellectual disabilities, mental health challenges, or physical disabilities.- Knowledge of ADA (Americans with Disabilities Act) and other workplace laws regarding disability inclusion and accommodations.- UNT-WISE credential or a comparable credentialing program is required. This must be obtained after hire, with annual recertification required. Familiarity with its structure and reporting standards is beneficial.- Experience with documentation and reporting processes tied to vocational or employment support programs is highly valued.
**Physical Requirements**
- Prolonged periods of sitting at a desk and working on a computer.- Must be able to lift to 15 pounds at times.- While performing the duties of this job, the employee is frequently required to walk; balance; stoop, kneel, crouch, and talk or hear.- The ability to cope with and tolerate moderate levels of stress is also a necessity. Specific vision abilities required by this job include close vision, distance vision, depth perception and ability to adjust focus.
** **
**Equal Employment Opportunity Statement:**
...
- **Salary:** $0.00 - $21.28
- **Posted:** May 20, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=579355)**

#### Job Description

The Disability Career Case Manager supports the basic needs and service coordination for Goodwill clients with disabilities seeking assistance with education, job training, internships and employment-related services. The Disability Career Case Manager will work closely with clients in developing internship/work experiences, service plans including goals for training, education, and employment as well as providing continued programmatic follow-up supports postplacement. The Disability Career Case Manager works closely with other Workforce Advancement professionals, the Texas Workforce Commission – Vocational Rehabilitation, and additional community partners in coordinating services provided within and outside of Goodwill. 
*This position is located at our South Austin location:  6505 Burleson Rd. ATX 78744
**Role and Responsibilities**
- Maintain client caseloads by supporting client’s development with respect to resume building, job applicants/job searching, interviewing and employment related soft skills. Maintain frequent contact with clients in accordance with agency policy and procedures. - Develop partnership with clients, a strengths-based/solution-focused assessment and individualized career plan that identifies short- and long-term goals and resources that support clients on their path towards their education, training and employment goals. Track and document goal acquisitions and support clients in their transition to the next steps according to their individual career plan. - Lead internship programs, contingent on program launch and funding. Focused on establishing employer relationships and leveraging pipelines to foster short term and long term work experiences for individuals with disabilities.- Ensure compliance with Texas Workforce Commission – Vocational Rehabilitation program requirements.- Apply extensive knowledge of regional labor market needs and trends which will support an evidence-based career path for clients. - Provide onsite job coaching, including skill development, workplace behavior, and accommodations to clients, specifically working with individuals with disabilities.- Coordinate with appropriate social services professionals in delivering services necessary to support clients in achieving employment stability. - Intervene effectively and ethically in crisis, developing applicable interventions and follow-up plans to thoroughly address immediate and future needs while maintaining safety. - Enroll clients in programs, obtain information and complete reports to meet/exceed all performance targets as required by Goodwill and other funding sources. - Maintain complete and accurate records of all clients through CaseWorthy and other required client tracking databases. Strictly adhering to all data entry requirements set forth by Goodwill and other funding sources. Adhere to confidentiality protocols related to electronic and paper files and documents. - Coordinate and work collaboratively with GCT Career Advancement Team to connect clients with career advancement training and the Business Solutions team to connect clients with employment opportunities. - quality and integrity of Career Advancement Services in CaseWorthy. Pull reports as needed for department. - Participate in and contribute to community collaborations and inter-agency discussions that further the Goodwill mission and clients’ goals. - Other duties as assigned.
**Supervisory Responsibility**
This position does not have supervisory responsibilities
...
** **
**Preferred Requirements**
- Certification in Job Coaching or Vocational Rehabilitation (e.g., CRC – Certified Rehabilitation Counselor, CPRW – Certified Professional Résumé Writer) is a plus.- Experience working with diverse populations, including individuals with intellectual disabilities, mental health challenges, or physical disabilities.- Knowledge of ADA (Americans with Disabilities Act) and other workplace laws regarding disability inclusion and accommodations.- UNT-WISE credential or a comparable credentialing program is required. This must be obtained after hire, with annual recertification required. Familiarity with its structure and reporting standards is beneficial.- Experience with documentation and reporting processes tied to vocational or employment support programs is highly valued- Fluency in American Sign Language (ASL) is preferred but not required..
**Physical Requirements**
- Prolonged periods of sitting at a desk and working on a computer.- Must be able to lift to 15 pounds at times.- While performing the duties of this job, the employee is frequently required to walk; balance; stoop, kneel, crouch, and talk or hear.- The ability to cope with and tolerate moderate levels of stress is also a necessity. Specific vision abilities required by this job include close vision, distance vision, depth perception and ability to adjust focus.
** **
**Equal Employment Opportunity Statement:**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587179)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587178)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 15, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587176)**
...
- **Salary:** $0.00 - $14.50
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587126)**

#### Job Description

Partner with team members in a high energy fast-paced environment to perform a variety of operational functions that include receiving, sorting, pricing, processing and preparing merchandise to ship and display for sale in a Goodwill retail store.
**Role and Responsibilities**
- Unload trucks arriving with orders of new goods.- Accurately check in shipments of new goods and communicate with the supervisor regarding any discrepancies.- Place products in appropriate locations for the order selection process.- Select individual store orders for merchandise and prepare for shipment.- Maintain an accurate count of current inventory on hand.- Maintain a clean and organized facility at all times.- Communicate with supervisor on a timely basis regarding any needed supplies.- Always maintain a professional demeanor.- Comply with all GCT policies, including, but not limited to, presorting theft or misuse of company property or other illegal activities.- Adhere to work schedule set by supervisor.- Other duties as assigned.
**Supervisory Responsibility**
This position does not have supervisory responsibilities
**Required Skills & Qualifications**
- Work a flexible schedule in support of the store opening, production, and closing operations including work on weekends and holidays.- A minimum of six months of previous work experience, or the equivalent educational or vocational experience preferred.- Must be able to follow directions well and communicate effectively in English.- Ability to problem solve.- Ability to provide exceptional customer service to all of our customers in a friendly and engaging way.   
**Physical Requirements**
- Ability to work in a non-climate-controlled environment.- Must be able to lift and carry up to 30 pounds at times. - Ability to perform continuous walking, stooping, standing, bending, kneeling and climbing for prolonged periods of time (up to 7 hours per 8 hour shift).- While performing the duties of this job, the employee is frequently exposed to airborne particles.
**What We Offer**
- **Comprehensive Health Coverage**: We provide top-tier medical, dental, and vision insurance to ensure you and your family stay healthy and happy.- **Generous Paid Time Off**: Recharge with our generous PTO policy, which includes vacation days, personal days, and company-wide holidays.- **Paid Parental Leave:** We understand the importance of family. We offer a generous parental leave policy to support you during this significant life event.- **Professional Development Opportunities**: We believe in continuous growth! Take advantage of our access to workshops and online courses.- **Wellness Programs**: Prioritize your well-being with our wellness initiatives, including gym memberships and mental health support.- **Employee Recognition Programs**: We celebrate our team members’ achievements with recognition awards.- **Diverse and Inclusive Culture**: Join a workplace that values diversity and inclusion, with regular team-building activities and events that foster a sense of belonging.
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Post offer background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
...
- **Salary:** $0.00 - $14.50
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587124)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587122)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586957)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586940)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 09, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586908)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 09, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586898)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 05, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586734)**

#### Job Description

**NOW HIRING: MERCHANDISE PROCESSORS**
**Be Part of Our NEW Goodwill Store Opening in Lockhart!**
**Location:** Lockhart, Texas
**Starting Pay:** $15/hour
**Full-Time & Part-Time Opportunities Available**
**JOIN THE TEAM THAT WILL OPEN OUR NEW STORE!**
Goodwill Central Texas is opening a brand-new store in Lockhart, and we’re building our team now!
As a Merchandise Processor, you’ll play an important role in getting our new store ready to open its doors. You’ll sort, price, prepare, and stock donated merchandise while helping create an exciting shopping experience for our community.
New hires will train at our San Marcos Goodwill location while we prepare for the Lockhart store opening.
If you enjoy hands-on work, staying active, spotting great finds, and being part of a team, this could be the opportunity for you!
**WHAT YOU’LL DO**
- Sort, hang, price, and prepare donated merchandise for the sales floor- Receive donations- Identify boutique, brand-name, vintage, and unique items - Meet daily processing goals while keeping your work area clean and organized- Transport and stock merchandise on the sales floor by category- Provide friendly customer service and assist with donation intake when needed- Cross-train in other areas of the store and jump in where help is needed- Help create a clean, organized, safe, and welcoming store environment- Work as part of a positive team that is focused on serving our customers and community
**WHAT YOU BRING**
- A positive attitude and strong team spirit- A strong work ethic and attention to detail- Ability to work in a fast-paced, physical environment- Ability to lift up to 30 lbs. and stand/walk for extended periods- Flexibility to work weekends and holidays- Ability to communicate clearly and follow directions in English- 6+ months of work, retail, or volunteer experience is a plus- Reliability and pride in doing quality work
Retail experience is helpful — but we’re willing to train the right person!
**WHAT YOU’LL GET**
- $15/hour starting pay
- Full-time and part-time opportunities- Flexible scheduling- Medical, dental, and vision insurance- Generous paid time off- Paid parental leave- Training, development, and career advancement opportunities- Wellness benefits, including gym discounts and mental health support- Employee recognition programs- Supportive, inclusive workplace culture
**WHY GOODWILL?**
At Goodwill, your work has purpose.
Every donation you process helps support job training, education, and employment services that create opportunities for people in our community.
When you join our Lockhart team, you’re helping build more than a store — you’re helping build opportunities.
Be part of the Lockhart opening team! Apply today and help us get Goodwill Lockhart ready to open its doors!
**Equal Employment Opportunity Statement**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 04, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586694)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586639)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586637)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586636)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586618)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586620)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586615)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586488)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 28, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586386)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 28, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586375)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 28, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586370)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 26, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586235)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 24, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586103)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 22, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586013)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 22, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586011)**

#### Job Description

Now Hiring: Merchandise Processor |
Enjoy hands-on work and staying active in a fast-paced retail environment? Bring your attention to detail and strong work ethic to a place where every item processed supports a meaningful mission. As a Merchandise Processor, you’ll play a vital behind-the-scenes role preparing products for the sales floor.  This isn’t just a job; it’s an opportunity to build valuable skills, grow your career, and make a real impact every day.
** **
**What You’ll Be Doing:**
- Sort, hang, price, and prep donated merchandise for the sales floor- Identify boutique, brand-name, and vintage items—become a resale expert!- Meet daily processing goals while keeping your area clean and organized- Transport merchandise to the sales floor and stock by category- Deliver friendly customer service and assist with donation intake when needed- Cross-train in other store areas to support wherever help is needed- Be part of a team that’s driven by purpose and fueled by positivity
** **
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 20, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585855)**
...
** **
**Why Join Us?**
At Goodwill, your work has purpose. Every donation you process helps fund job training, education, and support services for people in your community. When you join our team, you’re not just earning a paycheck—you’re changing lives. Ready to work hard, learn and fast.  Apply today and start your journey with Goodwill!
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 20, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585854)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 19, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585743)**
...
** **
**Why Join Us?**
At Goodwill, your work has purpose. Every donation you process helps fund job training, education, and support services for people in your community. When you join our team, you’re not just earning a paycheck—you’re changing lives. Apply today and start your journey with Goodwill!
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 18, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585719)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 16, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584452)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 16, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584451)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584386)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 13, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584317)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 07, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583891)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Jul 28, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583253)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Apr 07, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=576846)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587169)**
...
- **Salary:** $0.00 - $21.28
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586299)**
...
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586647)**

#### Job Description

The Infrastructure Engineer is responsible for the design, deployment, maintenance, and automation of the organization’s on-premises and cloud infrastructure. This role ensures reliable, secure, and scalable server, storage, and network solutions while supporting business operations and growth. The Infrastructure Engineer serves as a technical escalation point, collaborates closely with internal teams and third-party vendors, and drives infrastructure modernization through automation and best practices.
**Role and Responsibilities**
- Deploy, configure, and maintain physical and virtual servers, storage platforms, and core infrastructure systems.- Administer and manage cloud services, with a primary focus on Microsoft Azure, including computer, storage, networking, identity, and security services.- Design, implement, and maintain network solutions to support on-premises and cloud environments, ensuring performance, availability, and security.- Manage server, infrastructure, and device patching processes to ensure systems remain secure and compliant.- Identify, prioritize, and perform vulnerability remediation across infrastructure and cloud environments.- Implement and maintain infrastructure automation using scripting, Infrastructure as Code (IaC), and configuration management tools.- Monitor infrastructure health, performance, and capacity, proactively identifying and resolving issues.- Collaborate with internal IT teams to support application deployments, integrations, and system upgrades.- Serve as a technical liaison with third-party vendors, managed service providers, and cloud partners.- Participate in infrastructure planning, lifecycle management, and continuous improvement initiatives.- Develop and maintain technical documentation, diagrams, standards, and operational procedures.- Assist with disaster recovery planning, backup strategies, and business continuity testing.- Provide escalation support for complex infrastructure and network issues.- Stay current with emerging technologies, security practices, and industry trends.- Other duties as assigned.
** **
**Supervisory Responsibility**
This position does not have supervisory responsibilities.
**Required Skills & Qualifications **
- Bachelor’s degree in Information Technology, Computer Science, or a related field, or equivalent experience.- 5+ years of experience in infrastructure, systems engineering, or related roles.- Strong experience managing Windows Server environments and virtualization platforms.- Hands-on experience with Microsoft Azure cloud services and administration.- Basic knowledge of LAN, WAN, VPN, and firewall concepts, with hands-on experience supporting and troubleshooting network-related issues.- Experience with patch management tools and vulnerability remediation processes.- Experience working with third-party vendors and service providers.- Strong troubleshooting, analytical, and problem-solving skills.- Excellent written and verbal communication skills, with the ability to work effectively with technical and non-technical stakeholders.- Ability to manage multiple priorities in a fast-paced environment.- Availability to support after-hours maintenance or incident response as needed.- Familiarity with security frameworks and compliance requirements.- Experience with monitoring and alerting platforms.
**Preferred Qualifications**
- Azure certifications (AZ-104, AZ-305, or similar).- Experience with Fortinet network solutions- Experience with hybrid infrastructure environments.- Familiarity with scripting and automation tools such as PowerShell, Azure Automation, ARM/Bicep, Terraform, or similar is preferred.
**Physical Requirements**
- Prolonged periods of sitting at a desk and working on a computer.- Must be able to lift up to 30 pounds at times.- While performing the duties of this job, the employee is frequently required to walk; balance; stoop, kneel, crouch, and talk or hear.- Specific vision abilities required include close vision, distance vision, depth perception, and ability to adjust focus.
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
#IND2
Onsite: Monday-Friday: 8:00am-5:00pm
...
- **Salary:** $0.00 - $18.50
- **Posted:** Sep 10, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586954)**

#### Job Description

**INCLUSIVE EMPLOYMENT COMMITMENT & SECURITY REQUIREMENTS**
Team members play a vital role across various settings. As integral members of the team, they work closely with to ensure high-quality service and a well-maintained environment for clients.
Through the **Works Wonders program**, **75% of labor hours** within our contracts are designated for individuals with documented significant disabilities. This initiative provides meaningful employment opportunities, empowering individuals to achieve greater independence, reduce reliance on government assistance, and actively contribute to their communities. We strongly encourage applications from qualified candidates with documented disabilities who seek stable and rewarding employment in a supportive work environment.
**Please note that this position is within a ****secure facility and requires a Homeland security background check conducted at the federal level.**
**Summary of Position**
To provide mail processing and distribution service to DDS. Responsible for transforming data by indexing and scanning documents. Ensure the appropriate information from the documents is input into the IRON DATA system. Also responsible for quality control of each document.
**Job Description**
**Role and Responsibilities**
- Direct and coordinate staff activities to ensure contract goals and objectives are accomplished in the mailroom and scanning unit.- Assist with develops training programs for employees. Conduct cross-training designed to enhance performance and professional development.- Interact with internal and external customers in a professional manner.   Promote the mission of Goodwill.- Prepare reports and documentation for maintaining postal and DDS records.- Understands all phases of the DDS mailroom, scanning unit and switchboard. Reconciles quality concerns with the staff and mailroom manager when necessary. Makes corrections as needed.- Assist with payroll and personnel documentation.- Ensures that employees are performing job duties properly and using all equipment safely.- Support mailroom manager in maintaining a level of 75% disability for TIBH standards in accordance with contract specifications.- Order, stock, and distribute supplies needed for day-to-day operations. Ensure equipment is cleaned and properly maintained.- Other duties as assigned.
**Supervisory Responsibility**
This position does not have supervisory responsibilities.
**Required Skills & Qualifications**
- High school/GED.- Computer knowledge.- Two years’ experience in a mail processing center.- Good communication skills for dealing with internal and external customers.- Knowledge of US Postal regulations.- Ability to handle high stress situations.- Knowledge of Goodwill services and of community resources and business networking.- Texas Driver’s License, liability insurance, vehicle in good working condition, and good driving record.- Strong interpersonal, organizational and communication skills.- Hands-on experience with word processing and spreadsheet programs.- Creative and flexible problem solving.- Desire to work with employment and training services consumers, employees, and the public.
**Physical Requirements**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Sep 09, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586915)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Sep 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586831)**

#### Job Description

**RETAIL TEAM LEAD – NEW STORE OPENING**
**Be Part of the New Goodwill Store Opening in Lockhart!**
**ABOUT THE ROLE**
Goodwill Central Texas is opening a brand-new retail store in Lockhart, and we’re looking for a Retail Team Lead to help build and launch our new team!
The Retail Team Lead supports management in the overall operation of the Goodwill retail store, including customer service, cash management, facility operations, communications, merchandising, production, inventory control, and team development.
As part of our new-store opening team, you’ll help create a strong foundation for the Lockhart location by coaching team members, supporting daily operations, and helping ensure the store is ready to deliver an exceptional experience for customers, donors, and team members from day one.
The Retail Team Lead will have a primary team they are responsible for supporting when not assisting management with overall store operations. The assigned team may include the retail sales floor team or back-room production team, as determined by the Retail General Manager.
**ROLE & RESPONSIBILITIES**
- Assist the store management team with the overall operation of the retail store when scheduled or assigned.- Support the successful launch and ongoing operation of the new Lockhart location.- Help prepare the store for opening, including merchandising, production, inventory, organization, and operational readiness.- Coach, train, and develop associates on the assigned team as a subject matter expert.- Provide direction and support to team members to help achieve daily production, sales, and operational goals.- Ensure compliance with all Goodwill Central Texas policies and procedures, including reporting theft, misuse of company property, or other illegal activities.- Resolve customer complaints in a fair and impartial manner, referring unsettled disputes to the store manager.- Support a clean, safe, organized, and welcoming environment for customers, donors, and team members.- Assist with opening and closing procedures and securing the store as scheduled.- Support other store functions and responsibilities as assigned by the Retail General Manager.
**SUPERVISORY RESPONSIBILITY**
The Retail Team Lead is responsible for coaching, training, and providing day-to-day guidance to team members in assigned areas, including:
- AI Merchandise Pricer- Merchandise Processor- Sales Associate
This position does not have direct reports and works under the direction of the Retail General Manager and store management team.
**REQUIRED SKILLS & QUALIFICATIONS**
- At least 1 year of supervisory, team leadership, or equivalent experience.- Ability to work a flexible schedule in support of new-store opening, production, sales floor, opening, and closing operations.- Ability to effectively communicate in English with customers and Goodwill Central Texas associates.- Strong customer service, communication, coaching, and problem-solving skills.- Ability to lead by example and create a positive, team-oriented work environment.- Ability to work effectively in a fast-paced retail environment.- Ability to take ownership, adapt to changing priorities, and support the team where needed.- Ability to perform keyholder responsibilities, including opening and closing and securing the store as scheduled.- Big Joe certification required to load and unload trailers.
**PHYSICAL REQUIREMENTS**
- Ability to sit or stand for up to eight hours.- Ability to bend, twist, stoop, kneel, and reach.- Ability to lift and carry up to 30 pounds, with or without reasonable accommodation.- Ability to regularly stand, walk, talk, hear, and use hands and fingers to operate equipment, computers, telephones, and other tools.- Ability to perform physical tasks associated with retail, merchandising, production, stocking, and store operations.- Specific vision abilities required include close vision for computer and administrative work.- Regular, predictable attendance is required as business demands dictate.- Must be able to work a flexible schedule, including weekends and holidays, based on store and business needs.
**WHY JOIN THE LOCKHART OPENING TEAM?**
This is more than stepping into an existing store — you’ll help build a new one.
New-store team members will train and prepare at the San Marcos Goodwill location while the Lockhart store is being prepared for opening.
If you’re a hands-on leader who enjoys developing people, solving problems, and being part of something new, we want you on the team!
**Equal Employment Opportunity Statement**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position
...
- **Salary:** $17.00 - $19.00
- **Posted:** Sep 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586823)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Sep 02, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586619)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586511)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586464)**
...
- **Salary:** $18.00
- **Posted:** Aug 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586317)**
...
- **Salary:** $0.00 - $21.28
- **Posted:** Aug 25, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585857)**
...
- **Salary:** $24.00
- **Posted:** Aug 25, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586145)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 25, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586131)**
...
- **Location:** Excel Norwood Campus, Austin, TX, US
- **Type:** Full Time
- **Salary:** $51,266.00 - $66,025.00
- **Posted:** Aug 23, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583728)**

#### Job Description

The Goodwill Excel Center Adult High School is currently seeking a Student Success Coach for our **Norwood Campus**, located at 1015 Norwood Park Blvd. 
Company:
For more than six decades, **Goodwill Central Texas** has been relentlessly focused on empowering thousands of people to work. We transform revenue from over 37 retail locations into a combination of education, career training, job placement, career coaching and support, and more. Every time you shop or support Goodwill, you are helping fund our greater mission to serve our community. Goodwill’s vision extends far beyond our retail stores and your generous donations: We envision a Central Texas where everyone has the opportunity to thrive.
The **Goodwill Excel Center for Adults** opened in 2014 as an open-enrollment public charter high school for adults ages 18 to 50. The Excel Center Adult High School transforms lives in a supportive and holistic learning environment where all students are empowered to achieve. 
For more information on the Goodwill Excel Center Adult High School, visit https://excelcenterhighschool.org
...
**Role and Responsibilities**
- Guide students toward academic success through managing and monitoring student information (i.e. credits, tracking state testing, Language Credit by Exam process, etc.), developing class schedule, and assisting students in planning for graduation.- Advise students regarding educational decisions and disseminate program information. - Document all guidance interventions and scheduling actions in an electronic database in a proactive, timely, and ethical manner that meets quality and quantity standards.- Facilitate students’ learning experiences through individual and/or group coaching meetings to ensure student engagement with academic progression via course sequence and accomplishment of personal, academic, and career goals.- Coach students from a systemic, trauma-informed model that is strength-focused, student-driven, supportive and motivating, and that focuses on setting tangible, realistic, and measurable goals.   - Work collaboratively with students to develop detailed and regularly updated Personal Graduation and Career Plans to identify career goals and action steps.- Support and implement attendance and retention strategies by implementing proactive advising interventions that facilitate student connection to persistence in goals throughout the Excel Center student journey.- Intervene proactively and in a positive manner to address student behavioral needs that arise through early-identification of potential risk factors, collaboration with staff, facilitation of restorative meetings, monitoring of behavioral planning, and encouragement of pro-social and career-ready student behavioral.- Develop and implement student incentives and creative engagement strategies that recognize key educational/career/personal milestones to increase student buy-in and academic success.- Collaborate with instructors to develop student individual learning plans based on intake and ongoing benchmark assessments.- Provide support, work closely, and maintain open communication with staff and students to support student success.- Collaborate with Campus teams to ensure the successful transition of applicants to fully enrolled students and integration of students into the Excel Center environment via accurate and career-focused scheduling.- Coordinate with key community support persons for students (i.e. family members, friends, mentors, etc.) to build and sustain a network that will reinforce student progress.- Facilitate transitions with students by moving them efficiently and thoroughly toward graduation via their individualized pathway and coordinating with other school staff to ensure the continuum of support pre- and post-graduation.- Assist with the design a Master Schedule that meets the needs of students, TEA requirements, and strategic district objectives.- Maintain a suitable number of students per class by scheduling students appropriately. - Use personal vehicle to conduct home visits to students/family members in community, coordinate and document in-person referrals for wraparound care, and periodically transport students according to policy guidelines.  
** **
**Other Duties and Responsibilities**
- Assist school team with outreach efforts and community integration events throughout the school year (periodically nights and weekends).- Provide assistance, proctoring, and support for annual state testing administration.- Work collaboratively on Student Success Coaching District Team which may involve providing in person or remote support to or carrying caseloads from other campuses (South & North Austin & Justice Education Campuses).- Attend all team and professional meetings.
**Supervisory Responsibilities**
This position does not have supervisory responsibilities.  
**Required Skills and Qualifications**
- Associate degree or two years’ experience working with marginalized populations in an educational setting. - Valid Driver’s License, up to date auto insurance and good driving record.- Must be able to understand work instructions in English.- Must be bilingual in either Spanish or Arabic and English.- Must have a framework for understanding socioemotional, behavioral, and educational trends related to providing key student supports in an adult-academic setting.- Must have working knowledge of computer programs and accessing internet applications such as Student Information Systems, Microsoft Office Products, Google Applications (Gmail), Excel, Microsoft Word, and Internet Explorer.- Knowledge of community resources.- Must possess superior verbal and written communication skills.- Must be self-motivated willing to be a team player.- Must be adaptable to shifting priorities while maintaining a positive learning environment.- Strong socioemotional and behavioral intervention skills.- Must have the ability to embrace change positively and manage their workload independently.  - Ability to gather and analyze data for informed decision making.  - Ability to develop relationships and to relate to a diverse population.- Must possess the essential mindset that all students can achieve at high levels.- Must possess understanding of marginalization and how it impacts those Goodwill serves and employs.- Exhibit respect for diversity of thought and have experience to advance it in teams/organization.- Must demonstrate a maturity of practice using the 7 pillars and principles of servant leadership.- Must be able to successfully pass a background check and complete fingerprinting.  
**Preferred Qualifications**
- Bachelor’s Degree in Social Work, Education, Adult Education, School Counseling or related area of study. - Experience working with high school age students in urban, non-traditional, and/or adult education setting.- Experience working with adult learners.- Bilingual in Spanish or Arabic and English.  
- Perform other related duties as assigned.
Compensation & Schedule
- Based on experience and qualifications.- This is a year-round position.
What We Offer
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 23, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586031)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 12, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584242)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583932)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Aug 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583931)**
...
- **Salary:** $0.00 - $28.00
- **Posted:** Aug 05, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583750)**

#### Job Description

The Logistics Trainer will assist in road testing driver applicants for both CDL and non-CDL driving positions as well as providing training for current drivers as needed. When not conducting training tasks, the Logistics Trainer will be assigned normal driving duties within the Transportation Department operating a tractor trailer truck, box truck, or light van/pick-up to and from pickup and delivery points in a safe manner.
**Roles and Responsibilities**
- Partner with leadership to translate the organization's strategic plan into actionable human capital strategies that support business objectives and organizational success.- Conduct road testing for driver applicants and assist in the onboarding process.- Conduct individual and group training for current drivers as instructed by Logistics Manager.- Collaborate with Safety Team and Logistics Manager to provide regular training and instruction for drivers including post-incident corrective training.- Neatly and accurately complete required paperwork to include manifest, vehicle inspection report, driver logs, donation count sheets, and truck seals.- Accurately report incidents and accidents to supervisor.- Perform operator-level maintenance on assigned equipment to include daily checks for fuel, oil, lubricants, water, antifreeze, and vehicle condition.- Ensure safety of truck and equipment at dock to include chocking of tires.- Present neat and professional Goodwill Central Texas image to customers, stores, and the public.- Attend all scheduled meetings.- Provide excellent customer service.- Meet attendance and punctuality requirements.- Load and unload trailers by-hand/pallet jack.- In between pick up and drop offs, assist in material handling duties in warehouse as needed. This could include emptying boxes, moving pallets, sweeping trailers, docks, or areas around trailers to keep trash clear or other debris that may impact trailers.- Experience and/or familiarity with telematics, fleet routing software, and electronic duty logs.- Experience and/or familiarity with Smith System defensive driver training.- Other duties as assigned. 
**Supervisory Responsibility**
- This position does not have supervisory responsibilities.- Required Qualifications- Must be at least 21 years of age.- Must possess a valid Texas Class A Commercial Driver's License (CDL) with an acceptable driving record.- Must possess a valid Department of Transportation (DOT) Medical Examiner's Certificate.- Must be able to pass all applicable DOT physical and drug screening requirements.- Minimum of 2 years of commercial driving experience operating tractor-trailers or equivalent commercial vehicles.- Knowledge of DOT regulations, Hours of Service (HOS) requirements, and driver safety practices.- Ability to effectively communicate, read, write, and understand English.- Ability to accurately complete required reports, driver logs, manifests, and inspection documentation.- Basic computer skills and ability to use electronic logging devices (ELDs), telematics systems, and fleet management software.- Ability to conduct training, coaching, and performance evaluations for new and existing drivers.- Strong interpersonal, customer service, and presentation skills.
**Preferred Qualifications**
- Previous driver trainer, mentor, or instructor experience.- Experience conducting road tests and driver evaluations.- Familiarity with Smith System defensive driving principles.- Experience using fleet routing software, telematics platforms, and transportation management systems.- Warehouse, logistics, or distribution center experience.- Forklift or pallet jack experience.- Recommended Physical Requirements- Ability to safely lift, carry, push, and pull up to 50 pounds on a regular basis.- Ability to occasionally lift or move items weighing more than 50 pounds with assistance or appropriate equipment.- Ability to stand, walk, bend, stoop, squat, kneel, reach, and twist throughout the workday.- Ability to climb into and out of commercial vehicles, trailers, and loading docks repeatedly during a shift.- Ability to sit for extended periods while operating commercial vehicles.- Ability to use hands and fingers to operate vehicle controls, mobile devices, and electronic logging equipment.- Ability to safely load and unload freight using manual pallet jacks and other material handling equipment.- Ability to work indoors and outdoors in varying weather conditions and in non-climate-controlled environments.- Ability to safely perform duties in warehouse, dock, yard, and roadway environments.- Ability to meet all DOT physical qualification standards and maintain required certifications.- Ability to visually inspect vehicles, read gauges and instruments, and maintain situational awareness while operating equipment.- Ability to work flexible schedules, including early mornings, evenings, weekends, or overtime as business needs require.
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all Team Members. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $21.28
- **Posted:** Jul 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582959)**
...
- **Salary:** $16.00
- **Posted:** Jul 22, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582891)**
...
- **Salary:** $17.00 - $19.00
- **Posted:** Jul 20, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582671)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587168)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 09, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586897)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 08, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586830)**
...
**JOIN OUR NEW STORE OPENING TEAM!**
A brand-new Goodwill store is coming to Lockhart, Texas, and we're building our team now!
As a Sales Associate, you'll be part of the team helping bring our new store to life. You'll welcome customers, support donors, keep the sales floor looking great, and help create a positive shopping experience, all while supporting Goodwill's mission of transforming lives through the power of education and work.
**TRAIN WITH US BEFORE WE OPEN!**
New hires will train at our San Marcos Goodwill location while we prepare for the Lockhart store opening. This gives you the opportunity to learn our processes, build your skills, and get to know your team before opening day.
Ready to be part of something new? Join us!
**WHAT YOU'LL DO**
- Welcome every customer with warmth and professionalism, in the store, outside, or over the phone- Accurately and efficiently process purchases at the register- Keep the sales floor clean, organized, and stocked- Answer customer questions and share product knowledge- Assist donors at donation drop-off and provide receipts- Maintain fitting rooms and overall store appearance- Follow store safety and security procedures- Promote Goodwill's mission and support checkout donation efforts- Jump in and help wherever needed to keep the store running smoothly
**WHAT YOU BRING**
- A positive attitude and commitment to great customer service- Strong communication and active listening skills- Ability to work a flexible schedule, including weekends and holidays- Ability to work in a fast-paced, physically active environment and lift up to 35 lbs.- Ability to operate a register and follow directions- Retail experience is a plus, but we're willing to train the right person!
**WHAT YOU'LL GET**
$15/HOUR STARTING PAY
**Plus:**
- Full-time & part-time opportunities- Flexible scheduling- Medical, dental, and vision benefits- Generous PTO, personal days, and holidays- Paid parental leave- Training, development, and growth opportunities- Wellness perks, including gym discounts and mental health support- Employee recognition- An inclusive workplace where your voice and goals matter
**WHY WORK WITH US?**
This is more than a retail job, it's an opportunity to help build something from the beginning.
Every customer interaction, every donation, and every sale helps support Goodwill's mission of changing lives through education, training, and job placement.
**BE PART OF THE LOCKHART OPENING TEAM!**
Starting at $15/hour | Full-time & Part-time | Flexible Scheduling | Training Provided
Apply today and help us open the doors to Goodwill Lockhart!
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586635)**
...
** **
**What You’ll Get:**
- $1/hour raise after 90 days of employment!- Health Benefits – Medical, dental, and vision insurance- Generous PTO – Vacation days, personal days, and holidays- Paid Parental Leave – Support for growing families- Growth Opportunities – Training, workshops, and a clear path forward- Wellness Perks – Gym discounts, mental health support- Employee Recognition – We see and celebrate your hard work- Inclusive Culture – Be part of a team that values you, your voice, and your goals
** **
**Why It Matters:**
Every shift, every sale, every interaction supports Goodwill’s mission of changing lives through education, training, and job placement. You’re not just helping customers—you’re helping communities thrive. Ready to grow, shine, and earn more in just 60 days? Apply now and bring your talents to a team that’s all about purpose, passion, and progress.
**Equal Employment Opportunity Statement:**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586538)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 31, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586500)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 30, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586431)**
...
** **
**Why It Matters:**
Every shift, every sale, every interaction supports Goodwill’s mission of changing lives through education, training, and job placement. You’re not just helping customers—you’re helping communities thrive.  Apply now and bring your talents to a team that’s all about purpose, passion, and progress.
**Equal Employment Opportunity Statement:**
Goodwill Central Texas is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. All qualified applicants will receive consideration for employment without regard to race, color, religion, sex, national origin, age, disability status, protected veteran status, gender identity, sexual orientation, or any other characteristic protected by law.
**Background Check Requirement:**
Employment is contingent upon the successful completion of a pre-employment background check. This may include verification of employment history, education, criminal background, and other information relevant to the position.
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 28, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586376)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 27, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586303)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 21, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586000)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 21, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585935)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 17, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584478)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 16, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584454)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=584387)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583557)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Aug 03, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=583481)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Jul 23, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=582934)**
...
- **Salary:** $24.00 - $29.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586556)**
...
- **Salary:** $24.00 - $29.00
- **Posted:** Sep 01, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=586555)**
...
- **Salary:** $0.00 - $15.00
- **Posted:** Aug 19, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=585735)**
...
- **Salary:** $0.00 - $14.00
- **Posted:** Sep 14, 2026
- **[Apply Here](https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=cf5674db-9e68-440d-9919-4e047e6a1415&ccId=19000101_000001&lang=en_US&selectedMenuKey=CareerCenter&jobId=587114)**

#### Job Description

**Summary of Position**
To assist in the overall operation of the eCommerce store, including accepting and processing donations, assisting online customers, shelving and shipping orders. 
**Role and Responsibilities**
- Adheres to the assigned work schedule and punctuality are an essential function of the job.- Ensures work areas are maintained and organized.   Work areas are cleaned at the end of each day. Maintains cleanliness in storage and production areas.- Maintains a positive, team-oriented relationship with management, peers, and subordinates.- Efficiently package all items for shipment. In an accurate and timely fashion ship out all sold product to the correct customer.- Locate and collect all orders for shipping.- Handle all customer service related to order fulfillment including but not limited to, requests for tracking information, local pick-up requests and combined shipments.- Maintains the shipping supply inventory and generate requests proactively to restock supplies.- Maintain a records database tracking shipping costs and quantity of parcels shipped.- Maintains and assures safety in work areas.- Ensures compliance with policies and procedures.- Meets goals and fulfills responsibilities.- Other duties as assigned.
**Supervisory Responsibility**
This position does not have supervisory responsibilities.
**Required Skills & Qualifications**
- Prior experience working in a warehouse environment preferred.- Must be able to multi-task to meet daily production quotas.- Must be able to read, write, understand and follow directions in English.
**Physical Requirements**
- Ability to work in a non-climate-controlled environment.- Must be able to lift and carry up to 50 pounds at times.- Must be able to stand, bend and twist for eight hours.- While performing the duties of this job, the employee is frequently exposed to airborne particles.
All qualified applicants will receive consideration for employment without regard to race, color, sex, sexual orientation, gender identity, religion, national origin, disability, veteran status, age, marital status, pregnancy, genetic information, or other legally protected status. Post offer background check is required to ensure applicant meets all eligibility requirements for the assigned customer/location. Alternative work locations may be offered as appropriate.
